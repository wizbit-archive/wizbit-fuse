...
namespace Fuse {
	...
	public static delegate int Read(string path, char *buf, size_t size, long offset, FileInfo fi);
	// public static delegate int Write(string path, const char *buf, size_t size, off_t offset, FileInfo fi);
